...
class _LocationDetailScreenState extends State<LocationDetailScreen> {
  late final Future<List<Result>> _residentsFuture;

  @override
  void initState() {
    super.initState();
    _residentsFuture = _fetchResidents(widget.location.residents ?? []);
  }
  ...
  Future<List<Result>> _fetchResidents(List<String> urls) async {
      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            Row(
              children: [
                _buildInfoTile(Icons.category, 'TYPE', loc.type ?? '-'),
